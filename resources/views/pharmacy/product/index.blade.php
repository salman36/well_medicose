                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                <a class="btn btn-success mb-3" href="{{ route('pharmacy.pharmacyproduct.create') }}">Add
                                    Products</a>
                                    ...
                                    <tbody>
                                        @foreach ($product as $products)
                                            <tr>
                                                ...
                                                {{-- checks through ternory operator --}}
                                                {{-- <td>
                                                    {{ $products->brand ? $products->brand->title : 'N/A' }}
                                                </td> --}}
                                                <td>{{ $products->type }}</td>
                                                <td>
                                                ...
                                                <td
                                                    ...
                                                    @if ($products->is_active == 1)
                                                        <a href="{{ route('pharmacy.product.status', ['id' => $products->id]) }}"
                                                    ...
                                                    <a class="btn btn-info"
                                                        href="{{ route('pharmacy.pharmacyproduct.edit', $products->id) }}">Edit</a>
                                                    <form method="post"
                                                        action="{{ route('pharmacy.pharmacyproduct.destroy', $products->id) }}">
                                                        @csrf
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.product-data', function() {
            ...
            $.ajax({
                ...
                url: "{{ url('pharmacy/pharmacyproduct/show') }}",
                data: {
                    'id': id,
                },
