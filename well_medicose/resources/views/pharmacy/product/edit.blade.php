        ...
        <div class="main-content">
            <section class="section">
                <div class="section-body">
                    ...
                    <form id="add_student" action="{{ route('pharmacy.pharmacyproduct.update', $product->id) }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            $('#category-dropdown').on('change', function() {
                ...
                $.ajax({
                    ...
                    url: "{{ url('pharmacy/get-subcategories/{id}') }}",
                    type: "GET",
                    data: {
        ...
        $(document).ready(function() {
            ...
            <div class="fieldsContainer${fieldCounter}">
                <a class="btn btn-danger mb-3 mt-3 removeFieldButton" style="padding: 0 14px !important;margin-left: 0px;" data-target="${fieldCounter}">-</a>
                <div class="row">
                    <div class="col-sm-3 ">
                        <div class="form-group mb-3">
                            <label>Units</label>
                    ...
                    <div class="col-sm-3 ">
                        <div class="form-group mb-3">
                            <label>Discount(optional)</label>
                            <input type="number" placeholder="Enter price" name="discount[]" id="discount${fieldCounter}" class="form-control" />
                            // @error('discount')
                            //     <div class="text-danger">{{ $message }}</div>
                            // @enderror
                        </div>
