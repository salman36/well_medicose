                                    ...
                                    <div class="row mx-0 px-4">
                                        <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" placeholder="Enter Pharmacy Name" name="branch_name"
                                                    id="branch_name"
                                                    class="form-control">
                                                @error('branch_name')
                                    ...
                                    <div class="row mx-0 px-4">
                                        <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="number" placeholder="Enter branch no" name="branch_no"
                                                    id="branch_no"  class="form-control">
                                                @error('branch_no')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row mx-0 px-4">
                                        <div class="col-sm-6 pl-sm-0 pr-sm-2">
                                            <div class="form-group mb-3">
                                                <label>License</label>
                                                <input type="text" placeholder="Enter license" name="license" id="license"
                                                     class="form-control" />
                                                @error('license')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-sm-6 pl-sm-0 pr-sm-2">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" placeholder="Enter phone no" name="phone_no"
                                                    id="phone_no"
                                                    class="form-control" />
                                                @error('phone_no')
                                                    <div class="text-danger">{{ $message }}</div>
