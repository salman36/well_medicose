                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <h2 class="mb-3 font-18">{{$pharmacy_Count}}</h2>
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <h2 class="mb-3 font-18">{{$brand_Count}}</h2>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Featured Products</h5>
                                            <h2 class="mb-3 font-18">{{$featured_Count}}</h2>
                                            {{-- <p class="mb-0"><span class="col-green">42%</span> Increase</p> --}}
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                        <div class="banner-img">
                                            <img src="{{ asset('public/admin/assets/images/banner/FeaturedProduct.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
