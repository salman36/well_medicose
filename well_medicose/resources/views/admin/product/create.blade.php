    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                ...
                <form id="add_student" action="{{ route('product.store') }}" method="POST"
                                ...
                                <div class="card">
                                        ...
                                        <div class="row" style="width: 90%; margin:auto">
                                            <div class="col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <select class="form-control selectric" name="pharmacy_id[]"
                                                        multiple>
                                                        <option value="" disabled selected>Select Pharmacy
                                                        </option>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <select name="type" class="form-control">
                                                        ...
                                                        <option value="Syrup">Topical</option>
                                                        <option value="Suspension">Inhaler</option>
                                                    </select>
                                                    @error('type')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                    ...
                                    <div class="container" id="fieldsContainers">
                                        <a class="btn btn-success mb-3" id="addFieldButtons"
                                            style="padding: 0 14px !important; margin:10px 0px 10px 68px">+
                                            Instruction</a>
                                        <div class="row" style="width: 90%; margin:auto">
                                            <div class="col-sm-6">
                                    ...
                                    <div class="container" id="fieldsContainer">
                                        <a class="btn btn-success mb-3" id="addFieldButton"
                                            style="padding: 0 14px !important; margin:10px 0px 10px 68px">+ Product
                                            Detail</a>
                                        <div class="row" style="width: 90%; margin:auto">
                                            <div class="col-sm-3">
                                                <div class="form-group mb-2">
                                                    <label>Units</label>
                                                    <select name="units[]" class="form-control" id="" required>
